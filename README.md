...
3. Download and install the [Sage 200 JDBC Driver from CData](https://www.cdata.com/drivers/sage200/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
