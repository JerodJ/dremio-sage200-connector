...
@SourceType(value = "Sage200ARP", label = "Sage200",uiConfig = "sage200-layout.json")
public class Sage200Conf extends AbstractArpConf<Sage200Conf> {
  private static final String ARP_FILENAME = "arp/implementation/sage200-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sage200.Sage200Driver";
